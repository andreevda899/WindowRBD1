...
{
    public partial class Project : System.Windows.Window
    {
        public Project()
        {
            InitializeComponent();
        ...
        public object ExcelFileReader { get; private set; }
        ...
        private void DeleteCommand_Click(object sender, RoutedEventArgs e) //Происходит удаление записи из базы данных
        {
 		    if (txtBox1.Text != "")
  		    ...
  		    {
      	        System.Windows.MessageBox.Show("Введите в поисковик Номер проекта для удаления");
  		    }
        }
        ...
        private void btExport_Click(object sender, RoutedEventArgs e) // Экспорт данных из datagid в Excel
        {
            ...
            excel.Visible = true; 
            Excel.Workbook workbook = excel.Workbooks.Add("C:\\Users\\Пользователь\\Desktop\\WindowRBD1\\База Данных.xlsx");
            Excel.Worksheet sheet1 = (Excel.Worksheet)workbook.Sheets[uri];
	    ...
	    if (txtBox1.Text != "")
            ...
            {
                System.Windows.MessageBox.Show("Введите в поисковик Номер проекта");
            }
	}
    }
}
