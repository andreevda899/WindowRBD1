...
{
    public partial class Contract : System.Windows.Window
    {
	public Contract()
        {
            InitializeComponent();
        ...
        private void AreaCommand_Click(object sender, RoutedEventArgs e)  //Происходит заполнение данными datagrid
        {
            this.Hide();
