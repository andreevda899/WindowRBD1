...
{
    public partial class Meaning : System.Windows.Window
    {
        public Meaning()
        {
            InitializeComponent();
        ...
        {
            this.Hide();
            new FormLoading1("Back").ShowDialog();
        }

        private void AddCommand_Click(object sender, RoutedEventArgs e) // Открытие формы
        {
        ...
        private void EditCommand_Click(object sender, RoutedEventArgs e) // Открытие формы
        {
            if (RoleBox == "Proekt.Трансформанта1")
            {
        ...
        private void DeleteCommand_Click(object sender, RoutedEventArgs e) //Происходит удаление записи из базы данных
        {
 		    if (txtBox1.Text != "")
  		    ...
  		    {
      			    MessageBox.Show("Введите в поисковик " + Number.Content + " для удаления");
  		    }
        }
        ...
        private void btReport_Click(object sender, RoutedEventArgs e) // Экспорт данных из datagid в txt
        {
            ...
            {
                MessageBox.Show("Введите в поисковик " + Number.Content);
            }
        }
    }
}
